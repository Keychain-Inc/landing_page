            ...
            <div className="py-16 min-w-full flex flex-col justify-start items-center">
                ...
                <div className="py-4 w-full flex justify-center">
                    <div className="py-4 w-full">
                        <p className="text-justify md:text-cente text-md md:text-lg text-black px-2">
                ...
                <div className="py-1 w-full flex justify-center">
                    <div className="py-1  w-full">
                        <h2 className="text-center text-xl  md:text-2xl font-bold text-black px-2">
                            Key concepts
                        </h2>
                    </div>
                </div>
                ...
                <div className="py-1 w-full flex justify-center">
                    <div className="py-1 w-full">
                        <p className="text-justify md:text-center text-md  md:text-lg text-black px-2">
                ...
                <div className="py-4 w-full flex justify-center">
                    <div className="py-4 content-box w-full">
                        <h3 className="text-center text-xl  md:text-2xl font-bold text-black px-2">
                            Definitions
                        </h3>
                    </div>
                </div>
                ...
                <div className="py-2 w-full flex justify-center">
                    <div className="py-2 w-full">
                        <p className="text-justify text-md  md:text-lg font-bold text-black px-2">
                            Address
                        </p>
                ...
                <div className="py-2 w-full flex justify-center">
                    <div className="py-2 w-full">
                        ...
                        <p className="text-justifytext-md  md:text-lg text-black px-2">
                ...
                <div className="py-2 w-full flex justify-center">
                    <div className="py-2 w-full">
                        <p className="text-justifytext-md  md:text-lg font-bold text-black px-2">
                            Blockchain
                        </p>
                        <p className="text-justify text-md  md:text-lg text-black px-2">
                ...
                <div className="py-2 w-full flex justify-center">
                    <div className="py-2 w-full">
                        <p className="text-justify text-md  md:text-lg text-black px-2 break-words">
